...
prompt = ChatPromptTemplate(
    [("system", "You are a wise genius who gives advice to humans related to the topic they provide. "
...
response = chain_with_history.invoke({"input": "Global Warming"}, {
    "configurable": {
        "session_id": "chat_1"
    }
})
...
response = chain_with_history.invoke({"input": "What was our last topic?"}, {
    "configurable": {
        "session_id": "chat_1"
    }
})
